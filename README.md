...
- **Carry In (Cin)** — Input carry from a previous lower significant bit  

The Full Adder produces two outputs:

- **Sum (S)** — The binary sum of the three inputs  
- **Carry Out (Cout)** — The carry bit generated when the sum exceeds 1  
...
2. **Run Behavioral Simulation**
   ...
   * Click: **Flow Navigator → Run Simulation → Run Behavioral Simulation**
...
**Abhisekh Barman**
💻 Electronics & Computer Enthusiast | Learning Digital Design, Computer Architecture, and Verification
...
`Verilog` · `Vivado` · `Full Adder` · `Combinational Logic` · `Digital Design` · `FPGA` · `Testbench`
...
2. Open your project folder → open or create `README.md`.  
